 ...
 * It will generate compile time error if we add another abstract method.
...
public interface FunctionalInterfaceExample {
     ...
     * In case 2 Interfaces have the same default method (Diamond Problem), the implementation has to have its own version of the method (override).
     * If any class in the hierarchy has a method with same signature as a default interface method,
